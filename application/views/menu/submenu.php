...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addSubModal">Add New Submenu</a>
...
<!-- Modal -->
<div class="modal fade" id="addSubModal" tabindex="-1" role="dialog" aria-labelledby="addSubModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addSubModalLabel">Add New Sub Menu</h5>
